...

{
...

    {
        ...
        while(infinity>0)
        {
            ...
            System.out.println("WELCOME TO THE ӇƛƝƊ ƇƦƖƇƘЄƬ");
            System.out.println("");
            ...
            for(ii=0;ii<1;ii++) { if(cheat>0)
                ...
                {
                    System.out.println("You have been defeated by the AI!!");
                }

                else
                {
                    System.out.println("It's a Tie..! Prepare for your next match");
                }
